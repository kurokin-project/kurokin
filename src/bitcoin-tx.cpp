...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s kurokin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  kurokin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded kurokin transaction") + "\n" +
              "  kurokin-tx [options] -create [commands]   " + _("Create hex-encoded kurokin transaction") + "\n" +
              "\n";
