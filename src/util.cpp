...
const char * const BITCOIN_CONF_FILENAME = "kurokin.conf";
const char * const BITCOIN_PID_FILENAME = "kurokin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Kurokin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Kurokin";
#else
    // Unix
    return pathRet / ".kurokin";
#endif
#endif
}
