...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/kurokin-project/kurokin>";
    const std::string URL_WEBSITE = "<https://oil.vision/kurokin/>";
